...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        compute2("Kotlin", 10)
        compute2(age = 24)
        compute2(age = 24, name = "Kotlin")
        compute2(age = 24, value = 90, name = "Kotlin")
        compute2(value = 90, age = 24, name = "Kotlin")

        compute3()
        compute3("Kotlin")
        compute3("Kotlin", "ll")
        compute3("Kotlin", "kk", "tt")

        val names = arrayOf("Kotlin", "kk", "tt")
        compute4(* names)
